...
class _AuthenticationError(AuthenticationError):
    ...
    def __init__(self, *, code: int, msg: str | None = None, headers: dict[str, Any] | None = None) -> None:
        """
        初始化认证错误
...
class JwtAuthMiddleware(AuthenticationBackend):
    ...
    def auth_exception_handler(conn: HTTPConnection, exc: AuthenticationError) -> Response:
        ...
        :return:
        """
        exc = cast("_AuthenticationError", exc)
        return MsgSpecJSONResponse(content={"code": exc.code, "msg": exc.msg, "data": None}, status_code=exc.code)

    async def authenticate(self, request: Request) -> tuple[AuthCredentials, GetUserInfoWithRelationDetail] | None:  # type: ignore[override]
        """
        认证请求
        ...
        try:
            ...
            raise _AuthenticationError(code=exc.code, msg=exc.detail, headers=exc.headers)  # type: ignore[arg-type]
