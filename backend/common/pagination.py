...
class _CustomPage(_PageDetails, AbstractPage[T], Generic[T]):
    ...
    def create(  # type: ignore
        ...
        params = cast("_CustomPageParams", params)
        page = params.page
        size = params.size
...
async def paging_data(db: AsyncSession, select: Select) -> PageData[SchemaT]:
    """
    ...
    page_data = PageData[SchemaT](**paginated_data.model_dump())
    return page_data
