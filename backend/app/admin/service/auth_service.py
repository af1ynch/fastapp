...
class AuthService:
    ...
    async def swagger_login(self, *, obj: HTTPBasicCredentials) -> tuple[str, GetUserInfoDetail]:
        """
        Swagger 文档登录
        ...
        async with async_db_session.begin() as db:
            ...
            return access_token.access_token, GetUserInfoDetail.model_validate(user)
