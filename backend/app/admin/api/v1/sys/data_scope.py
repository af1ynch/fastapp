...
async def get_all_data_scope() -> ResponseSchemaModel[Sequence[GetDataScopeDetail]]:
...
async def get_data_scopes_paged(
    ...
    page_data: PageData[GetDataScopeDetail] = await paging_data(db, data_scope_select)
