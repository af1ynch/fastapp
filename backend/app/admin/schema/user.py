...
class AddOAuth2UserParam(AuthSchemaBase):
    ...
    password: str | None = Field(None, description="密码")  # type: ignore
    nickname: str | None = Field(None, description="昵称")
    email: CustomEmailStr | None = Field(None, description="邮箱")
...
class GetCurrentUserInfoWithRelationDetail(GetUserInfoWithRelationDetail):
    ...
    dept: str | None = Field(None, description="部门名称")  # type: ignore
    roles: list[str] = Field(description="角色名称列表")  # type: ignore
